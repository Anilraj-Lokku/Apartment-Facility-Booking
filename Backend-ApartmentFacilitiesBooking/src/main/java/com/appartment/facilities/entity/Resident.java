...
public class Resident extends User{
    ...
    public Resident(String userName, String password, String role, String status, String name, String flatNo, String flatType, String phone, String email, String picture) {
